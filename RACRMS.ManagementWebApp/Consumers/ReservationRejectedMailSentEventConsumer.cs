...
{
    public class ReservationRejectedMailSentEventConsumer : IConsumer<ReservationRejectedMailSentEvent>
    {
        private readonly IReservationBL reservationBL;

        public ReservationRejectedMailSentEventConsumer(IReservationBL reservationBL)
        {
            this.reservationBL = reservationBL;
        }

        public async Task Consume(ConsumeContext<ReservationRejectedMailSentEvent> context)
        {
            try
            {
